...
The site is built and deployed to the `gh-pages` branch with `npm run deploy`. To make https://srishtipalani.github.io/ live:

1. On GitHub, open your repo **Settings** → **Pages** (under "Code and automation").
